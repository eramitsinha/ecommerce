                ...
                <aside class="app-navbar">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li><a href="index.php" aria-expanded="false"><i class="nav-icon ti ti-comment"></i><span class="nav-title">Dashboard</span></a> </li>

                              <li><a href="upload-category.php" aria-expanded="false"><i class="nav-icon ti ti-comment"></i><span class="nav-title">Upload Category </span></a> </li>

                               <li><a href="category-list.php" aria-expanded="false"><i class="nav-icon ti ti-comment"></i><span class="nav-title">Category List </span></a> </li>

                               <li><a href="upload-product.php" aria-expanded="false"><i class="nav-icon ti ti-comment"></i><span class="nav-title">Add Product </span></a> </li>

                                <li><a href="product-list.php" aria-expanded="false"><i class="nav-icon ti ti-comment"></i><span class="nav-title">Products List </span></a> </li>

                                 <li><a href="user-list.php" aria-expanded="false"><i class="nav-icon ti ti-comment"></i><span class="nav-title">Users List </span></a> </li>

                                  <li><a href="orders.php" aria-expanded="false"><i class="nav-icon ti ti-comment"></i><span class="nav-title">Orders </span></a> </li>
